...
---  
  ...
  **5. SPI를 활용한 4-FND 제어**  
  ...
  <table align="left"> <tr> <td align="center">
        ...
        <sub><b>4자리 FND Timer 묘사</b></sub> </td> </tr> </table> <br clear="left"/>

  **6. Non-Preemptive Task Scheduler**  
  - 1ms/10ms/100ms/1000ms 단위로 작업을 분리하거나, Multi-tasking 구조 구현하기 위해 필요  

  <table align="left"> <tr> <td align="center">
        <img src="https://github.com/user-attachments/assets/011c1258-c110-43d7-8429-44f0a8eaf11b" width="220"/><br/>
