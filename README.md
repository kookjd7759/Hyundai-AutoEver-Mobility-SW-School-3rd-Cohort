...
> **📝 학습 내용**  
>   소프트웨어 개발에서 요구사항의 중요성을 이해하고, 이해관계자 중심의 요구사항 도출부터 분석·우선순위 결정·품질 명세까지 요구공학 전반의 프로세스를 학습하였다. 또한 요구사항 모델링과 SRS 작성 기준을 이해하고, 기능 요구사항과 비기능 요구사항을 체계적으로 명세하는 방법을 익혔다.
...
> **📝 학습 내용**  
> 정보보안의 기본 개념과 네트워크·운영체제 보안 위협을 이해하고, 암호학·취약점 분석·차량 E/E 아키텍처·보안 통신 구조를 학습. 또한 CVE/CVSS 기반 취약점 평가, 차량 사이버보안 표준과 OTA 보안, OWASP Top 10 및 시큐어코딩 원칙, AUTOSAR C++ 가이드와 UN R155 규정을 통해 차량 소프트웨어 개발에서 요구되는 보안 설계와 안전한 구현 방법을 이론과 실습으로 학습하였다.
