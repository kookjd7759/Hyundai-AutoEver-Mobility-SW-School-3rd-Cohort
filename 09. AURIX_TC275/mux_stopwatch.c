...
void fnd_display_unit(uint8_t value, uint8_t position, boolean dot);
...
void AppTask1ms(void)
{
    ...
    uint32 v = timeDisplay;

    switch(position)
    {
        case 0: fnd_display_unit((uint8)(v % 10), 0x1, FALSE); break;
        case 1: fnd_display_unit((uint8)((v / 10) % 10), 0x2, FALSE); break;
        case 2: fnd_display_unit((uint8)((v / 100) % 10), 0x4, TRUE); break;
        case 3: fnd_display_unit((uint8)((v / 1000) % 10), 0x8, FALSE); break;
        default: break;
    }
...
void AppTask10ms(void)
{
    ...
    if (IfxPort_getPinState(IfxPort_P02_1.port, IfxPort_P02_1.pinIndex) == FALSE)
    {
        btn1_cnt++;
        if (btn1_cnt == 3)
        {
